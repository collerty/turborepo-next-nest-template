...
export const SocialTokensFindManyArgsSchema: z.ZodType<Omit<Prisma.SocialTokensFindManyArgs, "select" | "include">> = z.object({
...
export default SocialTokensFindManyArgsSchema;
