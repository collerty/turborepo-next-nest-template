...
export const SocialTokensFindFirstOrThrowArgsSchema: z.ZodType<Omit<Prisma.SocialTokensFindFirstOrThrowArgs, "select" | "include">> = z.object({
...
export default SocialTokensFindFirstOrThrowArgsSchema;
