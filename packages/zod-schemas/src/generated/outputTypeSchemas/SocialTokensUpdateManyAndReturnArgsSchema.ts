...
export const SocialTokensUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.SocialTokensUpdateManyAndReturnArgs> = z.object({
...
export default SocialTokensUpdateManyAndReturnArgsSchema;
