...
export const UserCreateWithoutSocialTokensInputSchema: z.ZodType<Prisma.UserCreateWithoutSocialTokensInput> = z.object({
...
export default UserCreateWithoutSocialTokensInputSchema;
