...
import { AuthDialog, CommentsAuth, CommentsAuthSkeleton } from '@/components/auth/auth-dialog';
    ...
    <div className="container-wrapper flex-1 flex flex-col px-2">
      <div
        ...
        <div className="flex flex-col lg:w-(--comments-width) gap-4">
          <Suspense fallback={<CommentsAuthSkeleton />}>
            <CommentsAuth apiUrl={getApiUrl()} />
          </Suspense>
